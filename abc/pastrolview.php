...
<html lang="en">
    ...
    <body style="background-color: white; ">
        ...
        <!-- end navigation -->
 <br/><br/>
        <img src="images/past.jpg" width="100%" >
         <h2 style="font-size: 35px; margin-top: -100px;" class="wow bounceIn" data-wow-offset="50" data-wow-delay="1s"><b style="background-color: #24a0ed; " >Pastoral's</b><br/><span data-wow-delay="2s" style="color: #24a0ed;">Ministries</span></h2>
        <!-- start home -->
...
<div class="container-fluid" >
  <h1 style="color: #24a0ed; text-align: center; " ><b>Current Events</b></h1>
         <div class="container">
                          ...
                          <?php
                            $sql = "select * from pastrol where event='current' ";
                        ...
                        <div>
                          <?php
                            $sql = "select * from pastrolmore where event='current'";
                            $result = mysqli_query($conn, $sql);
                            if(mysqli_num_rows($result)){
                              while($row = mysqli_fetch_assoc($result)){
                          ?>
                        ...
                        <div class="container" style="margin-top: 50px;" >
                            ...
                            <?php
                            $sql = "select * from videpastrol where event='current' ";
                            $result = mysqli_query($conn, $sql);
                            if(mysqli_num_rows($result)){
                              while($row = mysqli_fetch_assoc($result)){
                          ?>
      ...
      <h1 style="color: #24a0ed; text-align: center;" ><b>Previous Events</b></h1>
                          <?php
                            $sql = "select * from pastrol where event='previous'";
                            $result = mysqli_query($conn, $sql);
                            if(mysqli_num_rows($result)){
                              while($row = mysqli_fetch_assoc($result)){
                          ?>
                        ...
                        <div>
                          <?php
                            $sql = "select * from pastrolmore where event='previous'";
                            $result = mysqli_query($conn, $sql);
                            if(mysqli_num_rows($result)){
                              while($row = mysqli_fetch_assoc($result)){
                          ?>
                      ...
                      <div class="container" style="margin-top: 50px;">
                            ...
                            <?php
                            $sql = "select * from videpastrol where event='previous' ";
                            $result = mysqli_query($conn, $sql);
                            if(mysqli_num_rows($result)){
                              while($row = mysqli_fetch_assoc($result)){
                          ?>
