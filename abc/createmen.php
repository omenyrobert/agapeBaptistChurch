      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="btn btn-outline-danger" href="men.php" style="color: black;"><h2>back</h2></a></li>
            </ul>
        </div>
      </div>
    </nav>
        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            <div class="card" style="color: black; font-size: 20px;">
              ...
              <div class="card-body">
                <form class="" action="addmen.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <button type="submit" name="addmen" class="btn btn-primary waves">Submit</button>
                    </div>
                </form>
              </div>
            </div>
