      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="btn btn-outline-danger" href="buk.php" style="color: black;"><h2>back</h2></a></li>
            </ul>
        </div>
      </div>
    </nav>
        ...
        <div class="row justify-content-center">
          <div class="col-md-6">
            <div class="card" style="color: black; font-size: 20px;">
              ...
              <div class="card-body">
                <form class="" action="addbuk.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <SELECT name="ministry" class="form-control" >
                        ...
                        <option>Marriage Ministry</option>
                        <option>Pastral Ministry</option>
                      </SELECT>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                      <button type="submit" name="bukadd" class="btn btn-primary waves">Submit</button>
                    </div>
                </form>
              </div>
            </div>
